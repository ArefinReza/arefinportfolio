            ...
            <Box className="details" sx={{ display: 'flex', gap: 4, mt: 2 }}>
              ...
              <Box>
                <Typography sx={{ display: 'flex', alignItems: 'center' }}>
                  <CakeIcon sx={{ marginRight: 1, color: 'primary.main' }} /> Birthday: January 1, 1990
                </Typography>
                <Typography sx={{ display: 'flex', alignItems: 'center' }}>
                  <WebIcon sx={{ marginRight: 1, color: 'primary.main' }} /> Website: www.example.com
                </Typography>
              </Box>
              ...
              <Box>
                <Typography sx={{ display: 'flex', alignItems: 'center' }}>
                  <PersonIcon sx={{ marginRight: 1, color: 'primary.main' }} /> Age: 30
                </Typography>
                <Typography sx={{ display: 'flex', alignItems: 'center' }}>
